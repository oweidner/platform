...
func Set(r render.Render, params martini.Params, db database.Datastore, data OrganisationStatus) {
	...
	stmt, err := db.GetDB().Prepare("UPDATE platform_organisation SET status_disabled=? WHERE id=?")
	if err != nil {
